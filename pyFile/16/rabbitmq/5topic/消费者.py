...
channel.queue_bind(exchange=exchange_name, queue=q1name, routing_key=topics[0]) # 将队列和某一个交换机关联
channel.queue_bind(exchange=exchange_name, queue=q2name, routing_key=topics[1]) # 将队列和某一个交换机关联
